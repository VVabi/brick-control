...
fn main() {
    env_logger::init();
    let subscriptions = vec![messages::SetMotorPwm::get_topic(), messages::MotorGoToPosition::get_topic(), messages::EnableModeUpdates::get_topic(), messages::RequestBatteryStatus::get_topic()];
